...
public class dbTester {
    public static void main(String[] args) throws Exception{
        ...
        boolean testaddNode = addNode("NDEPT00304", 1550, 1200, 4, "Faulkner","DEPT", "epistemology", "Dept 3", 'N');
        if(testaddNode){
        ...
        boolean testmodifyNode = modifyNode("NDEPT00104", 1300, 900, 4, "WPI", "DEPT", "Computer Room", "Dept 1", 'N');
        if(testmodifyNode){
